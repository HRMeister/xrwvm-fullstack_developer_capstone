...
def initiate():
    car_make_data = [
        {"name": "NISSAN",
         "description": "Great cars. Japanese technology", "num": 1},
        {"name": "Mercedes",
         "description": "Great cars. German technology", "num": 2},
        {"name": "Audi",
         "description": "Great cars. German technology", "num": 3},
        {"name": "Kia",
         "description": "Great cars. Korean technology", "num": 4},
        {"name": "Toyota",
         "description": "Great cars. Japanese technology", "num": 5},
    ]
    car_make_instances = []
    ...
    for data in car_model_data:
        CarModel.objects.create(name=data['name'], car_make=data['car_make'],
                                type=data['type'], year=data['year'], color=data['color'])
